...
function CandidatList({ candidateList }) {
    return (
        <div className=''>
            <h2 className='font-bold my-5'>Candidatos ({candidateList?.length})</h2>
                ...
                <div key={index} className='p-5 flex gap-3 items-center justify-between bg-white rounded-lg'>
                    <div className='flex items-center gap-5'>
                        ...
                        <div>
                            ...
                            <h2 className='text-sm text-gray-500'>Completado: {moment(candidate?.created_at).format('MMM DD, yyyy')}</h2>
                        </div>
                    </div>
