...
const InterviewComplete = () => {
    ...
    useEffect(() => {
        toast('Serás redireccionado al sitio web...')
        setTimeout(() => {
            router.replace('/')
        }, 3000)
    }, [])
    ...
    return (
        <div className="bg-midnight bg-white text-black font-sans antialiased flex flex-col min-h-screen">
            ...
            <main className="flex-grow flex flex-col items-center justify-center space-y-3 py-6">
                ...
                {/* Heading */}
                <h1 className="text-4xl font-bold text-center">¡Entrevista completa!</h1>

                {/* Subheading */}
                <p className="text-lg text-gray-400 text-center">
                    Gracias por participar en la entrevista impulsada por IA
                </p>
                ...
                <div className="bg-midnightLighter rounded-xl p-8 shadow-md w-full max-w-xl space-y-4">
                    ...
                    <h2 className="text-2xl font-semibold text-center">¿Que sigue?</h2>
                    <p className="text-gray-400 text-center">
                        El reclutador revisará sus respuestas de la entrevista y se comunicará con usted pronto con respecto a los próximos pasos.
                    </p>
                    <p className="text-gray-400 text-sm text-center">
                        ...
                        Respuesta en 2-3 días laborables
                    </p>
                </div>
                ...
                {/* <div className="flex space-x-4">
                    ...
                    <button className="bg-electricBlue hover:bg-electricBlueDark text-black rounded-lg py-3 px-6 flex items-center space-x-2 transition duration-300 ease-in-out">
                        <span>Ver otras oportunidades</span>
            ...
            <footer className="bg-midnightLighter text-gray-400 text-center py-4">
                <p>&copy; 2025 Entrevistador IA. Todos los derechos reservados.</p>
            </footer>
        </div>
    );
};
